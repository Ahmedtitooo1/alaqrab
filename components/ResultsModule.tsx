...
import { 
  ...
  Edit3, Trash2, CheckCircle, ArrowUpRight, X, BookOpen, Check, AlertCircle
} from 'lucide-react';
...
const ResultsModule: React.FC = () => {
  ...
  const submissions = [
    { id: '1', student: 'ياسين محمود', exam: 'فيزياء ذرية', score: 45, total: 50, date: '2024-03-22', code: 'STD-1002', answers: [
      { q: 'ما هو تعريف الذرة؟', studentAns: 'أصغر وحدة بناء للمادة', correctAns: 'أصغر وحدة بناء للمادة', isCorrect: true, points: 5 },
      { q: 'هل الضوء موجة كهرومغناطيسية؟', studentAns: 'خطأ', correctAns: 'صح', isCorrect: false, points: 0 }
    ]},
    { id: '2', student: 'سارة محمد', exam: 'فيزياء ذرية', score: 38, total: 50, date: '2024-03-22', code: 'STD-1005', answers: [] },
    { id: '3', student: 'أحمد علي', exam: 'مراجعة الميكانيكا', score: 25, total: 30, date: '2024-03-20', code: 'STD-1001', answers: [] }
  ];
  ...
  return (
    <div className="space-y-10 animate-view pb-20">
       <div className="hidden print:block text-center border-b-4 border-black pb-8 mb-10">
          ...
          <h2 className="text-xl font-bold mt-2">كشف نتائج الطلاب التفصيلي</h2>
       </div>

       <div className="flex flex-col md:flex-row justify-between items-center gap-6 no-print">
          <div className="flex items-center gap-6">
             <div className="p-5 bg-emerald-600 text-white rounded-[2rem] shadow-xl">
                <FileText size={40} />
             </div>
             <div>
                <h2 className="text-3xl font-black">دفتر النتائج والمراجعة</h2>
                <p className="text-slate-500 font-bold">يمكنك مراقبة أداء كل طالب بالتفصيل ومراجعة إجاباته.</p>
             </div>
          </div>
          ...
          <div className="p-6 border-b flex flex-col md:flex-row items-center gap-4 bg-slate-50/30 no-print">
             <div className="flex-1 relative w-full">
                ...
                <input 
                  ...
                  type="text" 
                  placeholder="بحث بكود الطالب، اسم الطالب، أو الاختبار..." 
                  className="w-full p-5 pr-14 bg-white border border-white rounded-[1.5rem] outline-none font-bold text-sm shadow-sm" 
                />
             </div>
          </div>
